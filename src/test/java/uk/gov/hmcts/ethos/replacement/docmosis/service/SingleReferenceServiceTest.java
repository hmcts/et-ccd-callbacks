...
public class SingleReferenceServiceTest {
    ...
    public void createEnglandWalesReference() {
        ...
        when(singleRefEnglandWalesRepository.ethosCaseRefGen(2022, ENGLANDWALES_CASE_TYPE_ID))
    ...
    public void createScotlandReference() {
        ...
        when(singleRefScotlandRepository.ethosCaseRefGen(2022, SCOTLAND_CASE_TYPE_ID))
                .thenReturn(expectedRef);
