...
public final class RolesConstants {
    ...
    public static final String TTL_PROFILE = "TTL_profile";
    ...
    public static final String SOLICITOR_2_EMAIL = "solicitor2@etorganisation1.com";
    ...
    static final String[] CASEWORKER_ROLES = {CASEWORKER_ET_PCQEXTRACTOR, CASEWORKER_CAA,
        ...
        CASEWORKER_APPROVER, PRD_AAC_SYSTEM, PRD_ADMIN, ACAS_API, GS_PROFILE, TTL_PROFILE, RAS_VALIDATION,
        WA_TASK_CONFIGURATION, "caseworker-divorce-solicitor", CASEWORKER_WA, CASEWORKER_WA_TASK_OFFICER,
        CASE_ALLOCATOR, CWD_USER, HEARING_CENTRE_ADMIN, HEARING_CENTRE_TEAM_LEADER, HEARING_MANAGER,
        HEARING_VIEWER, HMCTS_ADMIN, HMCTS_LEGAL_OPERATIONS, SENIOR_TRIBUNAL_CASEWORKER, SPECIFIC_ACCESS_APPROVER_ADMIN,
