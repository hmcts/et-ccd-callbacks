...
class CaseManagementForCaseWorkerServiceTest {
    ...
    private static Stream<Arguments> provideHearingCollectionsForNextListedDate() {
        HearingTypeItem hearingWithFutureDate = createHearingTypeItem("2027-01-01T10:00:00");
        ...
        return Stream.of(
                Arguments.of(List.of(hearingWithFutureDate, hearingWithPastDate), "2027-01-01"),
