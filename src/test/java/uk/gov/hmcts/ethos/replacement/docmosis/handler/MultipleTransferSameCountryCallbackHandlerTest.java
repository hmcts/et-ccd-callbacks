...
class MultipleTransferSameCountryCallbackHandlerTest {
    ...
    @Mock
    private MultipleTransferSameCountryService multipleTransferSameCountryService;

    private MultipleTransferSameCountryCallbackHandler handler;

    @BeforeEach
    void setUp() {
        handler = new MultipleTransferSameCountryCallbackHandler(
            caseDetailsConverter,
            verifyTokenService,
            multipleTransferSameCountryService
        );
    }
    ...
    void aboutToSubmitShouldNotTransferWhenTokenInvalid() {
        ...
        verify(multipleTransferSameCountryService, never()).transferMultiple(any(), any());
    }
    ...
    void aboutToSubmitShouldTransferWhenTokenValid() {
        ...
        when(multipleTransferSameCountryService.transferMultiple(multipleDetails, null)).thenReturn(List.of());

        handler.aboutToSubmit(callbackCaseDetails());

        verify(multipleTransferSameCountryService).transferMultiple(multipleDetails, null);
    }
