...
@Slf4j
@RestController
@RequestMapping("/admin/staff/employeemember")
@RequiredArgsConstructor
public class EmployeeMemberController {

    private final VerifyTokenService verifyTokenService;
    private final EmployeeMemberService employeeMemberService;

    @PostMapping(value = "/addEmployeeMember", consumes = APPLICATION_JSON_VALUE)
    @Operation(summary = "Add an employee member")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Accessed successfully"),
        @ApiResponse(responseCode = "400", description = "Bad Request"),
        @ApiResponse(responseCode = "500", description = "Internal Server Error")
    })
    public ResponseEntity<CCDCallbackResponse> addEmployeeMember(
