...
DROP TABLE IF EXISTS multipleReferenceEnglandWales;
CREATE TABLE multipleReferenceEnglandWales
(
    counter int

);
DELETE FROM multipleReferenceEnglandWales ; -- remove any existing values in case the script is ran more than once
INSERT INTO multipleReferenceEnglandWales VALUES (0);