...
locals {
  ...
  sharedVaultUri = data.azurerm_key_vault.et_shared_key_vault.vault_uri
...
module "et-ccd-callbacks" {
  ...
  app_settings                         = {
    ...
    ET_CCD_CALLBACKS_S2S_SECRET        = data.azurerm_key_vault_secret.microservicekey_et_ccd_callbacks.value
    ...
    ET_CCD_CALLBACKS_DB_HOST           = module.db.host_name
    ET_CCD_CALLBACKS_DB_PORT           = "5432"
    ET_CCD_CALLBACKS_DB_PASSWORD       = module.db.postgresql_password
    ET_CCD_CALLBACKS_DB_USER_NAME      = module.db.user_name
    ET_CCD_CALLBACKS_DB_NAME           = module.db.postgresql_database
    ET_CCD_CALLBACKS_DB_CONN_OPTIONS   = local.db_connection_options
...
resource "azurerm_key_vault_secret" "et_ccd_callbacks_s2s_secret" {
  ...
  value        = data.azurerm_key_vault_secret.microservicekey_et_ccd_callbacks.value
...
data "azurerm_key_vault_secret" "microservicekey_et_ccd_callbacks" {
