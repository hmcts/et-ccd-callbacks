...
public class RespondentTellSomethingElseService {
    ...
    private static final String VARIABLE_CONTENT_AMEND_RESPONSE =
            "<hr>Use this form to apply to amend the ET3 response."
                    + "<br><br>The tribunal will decide if you can make the amendment by judging the fairness of the "
                    + "application. This decision may be made at a hearing."
                    + "<br><br>The tribunal also needs to know if you consider the amendment minor or substantial."
                    + "<br><br>Providing details of why you want to amend the response and the importance of the amendment "
                    + "will help the tribunal to decide your application more quickly."
    ...
    private static final String VARIABLE_CONTENT_CLAIMANT_NOT_COMPLIED =
            "<hr>Use this form to tell us that the claimant has not complied with all or part of an order from the "
                    + "tribunal."
    ...
    private static final String VARIABLE_CONTENT_CONSIDER_A_DECISION_AFRESH =
            "<hr>Use this form to have a judgment or order made by a legal officer considered afresh by an Employment "
                    + "Judge."
    ...
    private static final String VARIABLE_CONTENT_ORDER_A_WITNESS_TO_ATTEND_TO_GIVE_EVIDENCE =
            "<hr>You can ask the tribunal to order a witness to attend to give evidence."
                    ...
                    + "The tribunal needs to understand why the evidence is relevant, "
                    + "and why there is no alternative way of establishing the same points at the hearing without "
                    + "ordering a witness to attend</li>"
    ...
    private static final String VARIABLE_CONTENT_RESTRICT_PUBLICITY =
            "<hr>Use this form to apply to prevent or restrict publicity in this case."
                    ...
                    + "<br><br>However, the tribunal has the power to prevent or restrict the public disclosure of any aspect "
                    + "of this case if necessary in the interests of justice or to protect the Convention rights of "
                    + "any person."
                    ...
                    + "<ul><li>that a hearing that would otherwise be in public be conducted, in whole or in part, "
                    + "in private</li>"
                    ...
                    + "<li>for measures preventing witnesses at a public hearing being identifiable by members of the "
                    + "public</li>"
