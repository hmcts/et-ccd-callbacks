package uk.gov.hmcts.ethos.replacement.docmosis.service.applications;
...
public class TseService {
    ...
    public List<String[]> getApplicationDetailsRows(GenericTseApplicationType application, String authToken,
                                               boolean rule92) {
     ...
     */
    public List<String[]> addDocumentsRows(List<GenericTypeItem<DocumentType>> documents, String authToken) {
