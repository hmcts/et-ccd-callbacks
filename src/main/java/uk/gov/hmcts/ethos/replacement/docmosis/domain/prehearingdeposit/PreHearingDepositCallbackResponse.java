...
public class PreHearingDepositCallbackResponse extends GenericCallbackResponse {
    private PreHearingDepositData data;

    public static ResponseEntity<PreHearingDepositCallbackResponse> getCallbackRespEntityNoErrors(
    ...
    public static ResponseEntity<PreHearingDepositCallbackResponse> getCallbackRespEntityErrors(
