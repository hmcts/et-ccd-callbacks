...
import uk.gov.hmcts.ethos.replacement.docmosis.controllers.ClaimantRepresentativeController;
...
public class RemoveOwnRepAsClaimantCallbackHandler extends CallbackHandlerBase {
    ...
    private final ClaimantRepresentativeController aboutController;

    @Autowired
    public RemoveOwnRepAsClaimantCallbackHandler(
        CaseDetailsConverter caseDetailsConverter,
        ClaimantRepresentativeController aboutController
    ) {
