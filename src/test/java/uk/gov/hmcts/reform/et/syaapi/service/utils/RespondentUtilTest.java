...
class RespondentUtilTest {
    ...
    void theFindRespondentSumTypeItemByIndex() {
        ...
        CaseUserRoleNotFoundException ex5 = assertThrows(CaseUserRoleNotFoundException.class, () ->
            RespondentUtil.findRespondentSumTypeItemByIndex(listWithNullValue, STRING_ZERO, CASE_ID));
        assertThat(ex5.getMessage()).contains(String.format(EXCEPTION_RESPONDENT_NOT_FOUND_WITH_INDEX,
                                                            STRING_ZERO));
    }
