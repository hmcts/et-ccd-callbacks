...
@Component
@Profile("prod")
public class ScotlandSingleProdDefinition implements CCDConfig<CaseData, CaseState, SingleRole> {
    @Override
    ...
    public void configure(ConfigBuilder<CaseData, CaseState, SingleRole> builder) {
        SingleDefinitionSupport.configure(builder, SingleDefinitionSupport.Variant.PROD_SCOTLAND);
    }
}
