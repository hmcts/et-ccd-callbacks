...
@WebMvcTest({AppealDocumentsController.class, JsonMapper.class})
class AppealDocumentsControllerTest {

    private static final String AUTH_TOKEN = "Bearer eyJhbGJbpjciOiJIUzI1NiJ9";
    private static final String ABOUT_TO_SUBMIT_URL = "/appealDocuments/aboutToSubmit";
