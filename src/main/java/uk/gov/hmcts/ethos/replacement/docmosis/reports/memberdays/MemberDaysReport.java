            ...
            if (!CollectionUtils.isEmpty(dateListedItems)) {
                for (var listedItem : dateListedItems) {
                    ...
                    if (hearingDate != null) {
                        ...
                        var hearingType = hearingItem.getValue();
                        if (hearingType.hasHearingEmployeeMember()) {
                            reportDetail.setEmployeeMember(hearingType.getHearingEEMember().getSelectedLabel());
                        }
                        if (hearingType.hasHearingEmployerMember()) {
                            reportDetail.setEmployerMember(hearingType.getHearingERMember().getSelectedLabel());
                        }
                        ...
                        if (listedItem.getValue().hasHearingClerk()) {
                            reportDetail.setHearingClerk(listedItem.getValue().getHearingClerk().getSelectedLabel());
                        }
