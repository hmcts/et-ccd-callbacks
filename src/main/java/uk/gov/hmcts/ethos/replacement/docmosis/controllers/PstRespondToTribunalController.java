...
import uk.gov.hmcts.ethos.replacement.docmosis.helpers.PstHelper;
 ...
 */
@Slf4j
@RequestMapping("/pstRespondToTribunal")
@RestController
@RequiredArgsConstructor
@SuppressWarnings({"PMD.UnnecessaryAnnotationValueElement"})
public class PstRespondToTribunalController {
    ...
    public ResponseEntity<CCDCallbackResponse> aboutToStart(
        ...
        caseData.setPstRespondentSelectOrderOrRequest(PstHelper.populateSelectJONDropdown(caseData));
