...
class HearingsToJudgmentsReportDataTest {
    ...
    private StringBuilder buildSummaryJsonString(String office, String totalCases, String total4Wk,
        ...
        sb.append(REPORT_OFFICE).append(office).append(NEW_LINE).append(TOTAL_CASES)
        .append(StringUtils.defaultIfEmpty(totalCases, "0")).append(NEW_LINE).append(TOTAL_WITHIN_4WEEKS)
        .append(StringUtils.defaultIfEmpty(total4Wk, "0")).append(NEW_LINE)
        .append(TOTAL_PERCENT_WITHIN_4WEEKS).append(StringUtils.defaultIfEmpty(total4WkPercent, "0.00"))
        .append(NEW_LINE).append(TOTAL_NOT_WITHIN_4WEEKS).append(StringUtils.defaultIfEmpty(totalX4Wk, "0"))
        .append(NEW_LINE).append(TOTAL_PERCENT_NOT_WITHIN_4WEEKS)
    ...
    private StringBuilder buildDetailJsonString(String caseReference, String hearingDate, String office,
        ...
        sb.append('{').append("\"reportOffice\":\"").append(office).append("\",")
        .append("\"caseReference\":\"").append(caseReference).append("\",")
        .append("\"hearingDate\":\"").append(hearingDate).append("\",")
        .append("\"judgementDateSent\":\"").append(judgementDateSent).append("\",")
        .append("\"totalDays\":\"").append(totalDays).append("\",")
        .append("\"reservedHearing\":\"").append(reservedHearing).append("\",")
        .append("\"hearingJudge\":\"").append(hearingJudge).append('\"').append('}');
        return sb;
    }
}