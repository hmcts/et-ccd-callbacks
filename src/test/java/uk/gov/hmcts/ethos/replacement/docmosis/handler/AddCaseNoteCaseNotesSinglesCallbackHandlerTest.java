...
class AddCaseNoteCaseNotesSinglesCallbackHandlerTest {
    ...
    private AddCaseNoteCaseNotesSinglesCallbackHandler handler;

    @BeforeEach
    void setUp() {
        handler = new AddCaseNoteCaseNotesSinglesCallbackHandler(caseDetailsConverter, caseNotesService);
    }
    ...
    void aboutToSubmitShouldDelegateToCaseNotesService() {
        ...
        verify(caseNotesService).addCaseNote(caseData, null);
    }
