...
public class ConciliationTrackService {
    ...
    static final List<String> JUR_CODE_CONCILIATION_TRACK_OP = Arrays.asList(
            "DAG", "DDA", "DRB", "DSO", "EQP", "PID", "RRD", "SXD");
    static final List<String> JUR_CODE_CONCILIATION_TRACK_ST = Arrays.asList(
    ...
    static final List<String> JUR_CODE_CONCILIATION_TRACK_SH = Arrays.asList(
            "BOC", "FML", "FPA", "FTC", "FTO", "FTP", "FTR", "FTS", "FTU", "PAY", "RPT", "WA", "WTR(AL)");
    static final List<String> JUR_CODE_CONCILIATION_TRACK_NO = Arrays.asList(
