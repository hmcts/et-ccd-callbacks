...
@Component
@Profile("cftlib")
public class ScotlandSingleCftlibDefinition implements CCDConfig<CaseData, CaseState, SingleRole> {
    @Override
    ...
    public void configure(ConfigBuilder<CaseData, CaseState, SingleRole> builder) {
        SingleDefinitionSupport.configure(builder, SingleDefinitionSupport.Variant.CFTLIB_SCOTLAND);
    }
}
