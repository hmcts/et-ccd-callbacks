...
public class BundlesRespondentPrepareDocCallbackHandler extends CallbackHandlerBase {
    ...
    private final BundlesRespondentController bundlesRespondentController;

    @Autowired
    public BundlesRespondentPrepareDocCallbackHandler(
        CaseDetailsConverter caseDetailsConverter,
        BundlesRespondentController bundlesRespondentController
    ) {
        super(caseDetailsConverter);
        this.bundlesRespondentController = bundlesRespondentController;
    }
    ...
    CallbackResponse<CaseData> aboutToSubmit(CaseDetails caseDetails) {
        ...
        return toCallbackResponse(
            bundlesRespondentController.aboutToSubmit(
    ...
    SubmittedCallbackResponse submitted(CaseDetails caseDetails) {
        ...
        return toSubmittedCallbackResponse(
            bundlesRespondentController.submitted(
                toCcdRequest(caseDetails),
                authorizationToken
            )
        );
