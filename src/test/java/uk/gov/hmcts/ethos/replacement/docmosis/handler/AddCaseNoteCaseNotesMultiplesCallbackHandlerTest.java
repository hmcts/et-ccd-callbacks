...
class AddCaseNoteCaseNotesMultiplesCallbackHandlerTest {
    ...
    private AddCaseNoteCaseNotesMultiplesCallbackHandler handler;

    @BeforeEach
    void setUp() {
        handler = new AddCaseNoteCaseNotesMultiplesCallbackHandler(caseDetailsConverter, caseNotesService);
    }

    @Test
    void aboutToSubmitShouldDelegateToCaseNotesService() {
        ...
        verify(caseNotesService).addCaseNote(multipleData, null);
    }
