...
class SingleUpdateServiceTest {
    ...
    public void setUp() {
        ...
        ReflectionTestUtils.setField(singleUpdateService, "ccdGatewayBaseUrl", "http://ccd-gateway");
    }
    ...
    void sendPreAcceptToSingleLogic() throws IOException {
        updateCaseMsg = MessageHandlerTestHelper.generatePreAcceptCaseMsg();
    ...
    void sendDisposeToSingleLogic() throws IOException {
        updateCaseMsg = MessageHandlerTestHelper.generateCloseCaseMsg();
