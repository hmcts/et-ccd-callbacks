...
import static uk.gov.hmcts.ethos.replacement.docmosis.helpers.RespondentTellSomethingElseHelper.getSelectedApplicationType;
...
class RespondentTellSomethingElseHelperTest {
    ...
    @Test
    void respondentTSEApplicationTypeDataException() {
        caseData.setResTseSelectApplication("aaron");
        assertThrows(IllegalArgumentException.class, () -> getSelectedApplicationType(caseData));
    }
