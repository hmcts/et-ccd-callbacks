...
DROP TABLE IF EXISTS subMultipleReferenceEnglandWales;
CREATE TABLE subMultipleReferenceEnglandWales
(
    multref int,
    submultref int
);

CREATE INDEX IX_subMultipleReferenceEnglandWales_multref ON subMultipleReferenceEnglandWales(multref);