...
@WebMvcTest({NotificationDocumentController.class, JsonMapper.class})
class NotificationDocumentControllerTest extends BaseControllerTest {

    private static final String ABOUT_TO_START_URL = "/notificationDocument/aboutToStart";
    ...
    protected void setUp() throws IOException, URISyntaxException {
        ...
        documentInfo = DocumentInfo.builder()
                ...
                .markUp("<a href=\"http://localhost:4004/documents/1234567890123456\">Document.pdf</a>")
                .build();
    }
