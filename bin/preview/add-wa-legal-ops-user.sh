...
# Usage: ./add-wa-legal-ops-user.sh <region_id> <location_id> <location> <service_code> <user_type> <task_supervisor> <case_allocator> <staff_admin> <suspended> <up_idam_status> <region>
# All arguments are optional and have defaults.

FIRST_NAME="ET"
LAST_NAME="LegalOps"
EMAIL_ID="et.caseworker011@hmcts.net"
REGION_ID=${1:-12}
