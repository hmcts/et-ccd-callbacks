...
public class ClaimsByHearingVenueReportParams extends ReportParams {
    ...
    public ClaimsByHearingVenueReportParams(String caseTypeId, String managingOffice, String dateFrom, String dateTo,
                                            String hearingDateType,  String userFullName) {
        super(caseTypeId, managingOffice, dateFrom, dateTo);
