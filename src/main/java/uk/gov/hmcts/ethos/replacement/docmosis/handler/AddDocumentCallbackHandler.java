...
import uk.gov.hmcts.ethos.replacement.docmosis.controllers.AddDocumentController;
...
public class AddDocumentCallbackHandler extends CallbackHandlerBase {
    ...
    private final AddDocumentController aboutController;

    @Autowired
    public AddDocumentCallbackHandler(
        CaseDetailsConverter caseDetailsConverter,
        AddDocumentController aboutController
    ) {
