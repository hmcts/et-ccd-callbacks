...
import static uk.gov.hmcts.ethos.replacement.docmosis.constants.NOCConstants.INVALID_NOTICE_OF_CHANGE_ANSWER_INDEX;
...
public final class NoticeOfChangeUtils {
     ...
     * @throws CallbacksRuntimeException if the index is outside the range 0–9
    ...
    public static void resetNoticeOfChangeAnswerByIndex(CaseData caseData, int index) {
        ...
        switch (index) {
            ...
            default -> throw new CallbacksRuntimeException(
