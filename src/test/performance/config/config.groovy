	...
	this.dynatraceMetricType = 'et-cos'
	...
	//this.dynatraceEntitySelectorPreview = 'type(service),tag(\\"[Kubernetes]namespace:et\\"),tag(\\"Environment:PREVIEW\\"),entityName.equals(\\"Et1ReppedController (PREVIEW) \\")'
