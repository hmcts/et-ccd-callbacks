...
import uk.gov.hmcts.ethos.replacement.docmosis.idam.models.TokenResponse;

/**
 * Service for getting OAuth2 access tokens from IDAM.
...
public class AccessTokenService {
    ...
    @Value("${idam.api.url.oidc:http://sidam-api:5000/o/token}")
