...
import uk.gov.hmcts.ecm.compat.common.model.reports.claimsbyhearingvenue.ClaimsByHearingVenueSearchResult;
import uk.gov.hmcts.ecm.compat.common.model.reports.claimsbyhearingvenue.ClaimsByHearingVenueSubmitEvent;
import uk.gov.hmcts.ecm.compat.common.model.reports.eccreport.EccReportSearchResult;
import uk.gov.hmcts.ecm.compat.common.model.reports.eccreport.EccReportSubmitEvent;
import uk.gov.hmcts.ecm.compat.common.model.reports.hearingsbyhearingtype.HearingsByHearingTypeSearchResult;
import uk.gov.hmcts.ecm.compat.common.model.reports.hearingsbyhearingtype.HearingsByHearingTypeSubmitEvent;
import uk.gov.hmcts.ecm.compat.common.model.reports.hearingstojudgments.HearingsToJudgmentsSearchResult;
import uk.gov.hmcts.ecm.compat.common.model.reports.hearingstojudgments.HearingsToJudgmentsSubmitEvent;
import uk.gov.hmcts.ecm.compat.common.model.reports.respondentsreport.RespondentsReportSearchResult;
import uk.gov.hmcts.ecm.compat.common.model.reports.respondentsreport.RespondentsReportSubmitEvent;
import uk.gov.hmcts.ecm.compat.common.model.reports.sessiondays.SessionDaysSearchResult;
import uk.gov.hmcts.ecm.compat.common.model.reports.sessiondays.SessionDaysSubmitEvent;
import uk.gov.hmcts.ecm.compat.common.model.schedule.ScheduleCaseSearchResult;
...
public class CcdClientTest {
    ...
    public void retrieveCasesElasticSearchForCreationManuallyCreated() throws IOException {
        ...
        when(restTemplate.exchange(eq(uri), eq(HttpMethod.POST), any(HttpEntity.class),
        ...
        verify(restTemplate).exchange(eq(uri), eq(HttpMethod.POST), any(HttpEntity.class), eq(CaseSearchResult.class));
        verifyNoMoreInteractions(restTemplate);
    }
    ...
    public void buildHeaders() throws IOException {
        ...
        // No need for UTF-8 encoding, as the default charset is already UTF-8 in Spring Boot 2.x and above.
