...
public final class RolesConstants {
    ...
    public static final String[] CASEWORKER_ROLES = {CASEWORKER_ET_PCQEXTRACTOR, CASEWORKER_CAA,
        ...
        HEARING_CENTRE_ADMIN, HEARING_CENTRE_TEAM_LEADER, HEARING_MANAGER, HEARING_VIEWER, HMCTS_ADMIN, HMCTS_LEGAL_OPERATIONS,
        SENIOR_TRIBUNAL_CASEWORKER, SPECIFIC_ACCESS_APPROVER_ADMIN, SPECIFIC_ACCESS_APPROVER_LEGAL_OPS, TASK_SUPERVISOR,
        TRIBUNAL_CASEWORKER, EMPLOYMENT_TRIBUNAL_CASEWORKER, EMPLOYMENT_HEARING_CENTRE_ADMIN, EMPLOYMENT_SENIOR_TRIBUNAL_CASEWORKER,
        EMPLOYMENT_HEARING_CENTRE_TEAM_LEADER, CWD_ADMIN, CWD_SYSTEM_USER, CTSC_TEAM_LEADER, REGIONAL_CENTRE_TEAM_LEADER, "allocated-admin-caseworker" };
