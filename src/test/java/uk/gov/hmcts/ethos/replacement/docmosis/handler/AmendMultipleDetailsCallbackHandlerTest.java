...
class AmendMultipleDetailsCallbackHandlerTest {
    ...
    private AmendMultipleDetailsCallbackHandler handler;

    @BeforeEach
    void setUp() {
        handler = new AmendMultipleDetailsCallbackHandler(
    ...
    @Test
    void aboutToSubmitShouldNotAmendWhenTokenInvalid() {
    ...
    @Test
    void aboutToSubmitShouldAmendWhenTokenValid() {
        MultipleDetails multipleDetails = multipleDetails();
        stubMultipleConverter(multipleDetails);
