...
public class DocumentConstants {
    ...
    public static final String APP_TO_EXTEND_TIME_TO_COMPLY_TO_AN_ORDER_DIRECTIONS_C = "App to extend time to comply to an order/directions – C";
    public static final String APP_TO_EXTEND_TIME_TO_COMPLY_TO_AN_ORDER_DIRECTIONS_R = "App to extend time to comply to an order/directions – R";
    ...
    public static final String APP_TO_STRIKE_OUT_ALL_OR_PART_OF_THE_CLAIM = "App to Strike out all or part of the claim";
    public static final String APP_TO_STRIKE_OUT_ALL_OR_PART_OF_THE_RESPONSE = "App to Strike out all or part of the response";
    ...
    public static final String APP_TO_HAVE_A_LEGAL_OFFICER_DECISION_CONSIDERED_AFRESH_C = "App to have a Legal Officer decision considered afresh - C";
    public static final String APP_TO_HAVE_A_LEGAL_OFFICER_DECISION_CONSIDERED_AFRESH_R = "App to have a Legal Officer decision considered afresh - R";
