...
--          :   12-NOV-2021     2.0 CCD Consolidation
-- =============================================
    ...
    WHEN office = 'ET_EnglandWales' THEN
        ...
        CASE
            ...
            WHEN (currentval + numofcases) > 99999  THEN
                UPDATE single_reference_englandwales
                SET counter = (numofcases + currentval) - 99999, cyear = RIGHT(currentyr, 2);
     ...
     WHEN office = 'ET_Scotland' THEN
        ...
        WHEN currentyr <> yr::text AND RIGHT(currentyr, 2) <> RIGHT(yr::text, 2) THEN
            ...
            currentyr = yr;
        WHEN (currentval + numofcases) > 99999  THEN
            UPDATE single_reference_scotland
            SET counter = (numofcases + currentval) - 99999, cyear = RIGHT(currentyr, 2);
