...
public class CaseLinksController {
    ...
    /**
     * Sends email confirmation of case linking and sets hearingIsLinkedFlag to true.
     */
    ...
    /**
     * Sends email confirmation of case unlinking and sets HearingIsLinkedFlag to false if no linked cases remain.
     */
