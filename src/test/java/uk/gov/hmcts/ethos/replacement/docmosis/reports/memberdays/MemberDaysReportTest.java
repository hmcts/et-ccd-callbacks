...
public class MemberDaysReportTest {
    ...
    public void setUp() {
        ...
        dateListedType2.setHearingClerk(new DynamicFixedListType("Clerk 1"));
    ...
    public void shouldIncludeOnlyCasesWithValidHearingDates() {
        ...
        var dateListedType6 = new DateListedType();
        dateListedType6.setHearingStatus(HEARING_STATUS_HEARD);
        dateListedType6.setHearingClerk(new DynamicFixedListType("Clerk55"));
        dateListedType6.setHearingAberdeen(new DynamicFixedListType("AberdeenVenue26"));
        dateListedType6.setHearingVenueDay(new DynamicFixedListType("Aberdeen6"));
    ...
    public void shouldParseCorrectHearingDurationForDateWithMilliseconds() {
        ...
        var dateListedType6 = new DateListedType();
        dateListedType6.setHearingStatus(HEARING_STATUS_HEARD);
        dateListedType6.setHearingClerk(new DynamicFixedListType("Clerk test"));
        dateListedType6.setHearingAberdeen(new DynamicFixedListType("AberdeenVenue26"));
        dateListedType6.setHearingVenueDay(new DynamicFixedListType("Aberdeen6"));
        dateListedType6.setListedDate("2019-12-29T12:11:55.000");
        dateListedType6.setHearingTimingStart("2019-12-29T13:11:55.000");
    ...
    public void shouldReturnZeroHearingDurationForNullHearingTimingFinish() {
        ...
        dateListedType.setHearingClerk(new DynamicFixedListType("Clerk A"));
        dateListedType.setHearingAberdeen(new DynamicFixedListType("AberdeenVenue"));
        dateListedType.setHearingVenueDay(new DynamicFixedListType("Glasgow"));
        dateListedType.setListedDate("2019-12-11T12:11:00.000");
