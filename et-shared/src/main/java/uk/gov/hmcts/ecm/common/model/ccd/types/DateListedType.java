...
public class DateListedType {
    ...
    @JsonProperty("hearingRoomLeedsWestgate")
    private String hearingRoomLeedsWestgate;
    ...
    @JsonProperty("hearingRoomLondonTribunalsCentre")
    private String hearingRoomLondonTribunalsCentre;
