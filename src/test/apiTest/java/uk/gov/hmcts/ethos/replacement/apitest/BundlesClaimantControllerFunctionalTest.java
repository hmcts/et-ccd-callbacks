...
@Slf4j
class BundlesClaimantControllerFunctionalTest extends BaseFunctionalTest {
    ...
    public void setUpCaseData() {
        ...
        caseData.setBundlesClaimantAgreedDocWith(YES);
        caseData.setBundlesClaimantSelectHearing(DynamicFixedListType.from("1", "hearing 1", true));
        caseData.setBundlesClaimantWhatDocuments(YES);
        caseData.setBundlesClaimantWhoseDocuments(YES);
    }
