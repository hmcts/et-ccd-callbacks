...
class ManageCaseRoleServiceUtilTest {
    ...
    @Test
    void isCaseRoleAssignmentExceptionForSameUserReturnsFalseWhenMessageIsNull() {
        assertThat(ManageCaseRoleServiceUtil.isCaseRoleAssignmentExceptionForSameUser(new Exception())).isFalse();
    }

    @Test
    void createAacSearchCaseUsersUriByCaseAndUserIdsReturnsEmptyWhenCaseIdsCannotBeDerived() {
    ...
    @Test
    void createAacSearchCaseUsersUriByCaseAndUserIdsIgnoresInvalidUserInfos() {
        List<CaseDetails> caseDetailsList = new CaseTestData().getRequestCaseDataListScotland();
    ...
    @Test
    void checkCaseDetailsListReturnsNullWhenFirstCaseStateIsNotAccepted() {
    ...
    void theGetRespondentSolicitorTypeFromIndex() {
        ...
        try (MockedStatic<EmployeeObjectMapper> employeeObjectMapper = mockStatic(EmployeeObjectMapper.class)) {
