CREATE OR REPLACE FUNCTION fn_ethosMultipleCaseRefGen (numofcases INT, office varchar(200))
...
BEGIN
    CASE
        WHEN office = 'ET_EnglandWales' THEN
            ...
            ELSE
                currentvalstr = CONCAT ('Exception - Not enough multiple reference numbers available in index multipleReference',
                    Office, ' to service requests');
            END IF;
