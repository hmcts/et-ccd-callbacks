...
import uk.gov.hmcts.ethos.replacement.docmosis.controllers.RefreshSharedUsersController;
...
public class RefreshSharedUsersCallbackHandler extends CallbackHandlerBase {
    ...
    private final RefreshSharedUsersController aboutController;

    @Autowired
    public RefreshSharedUsersCallbackHandler(
        CaseDetailsConverter caseDetailsConverter,
        RefreshSharedUsersController aboutController
    ) {
