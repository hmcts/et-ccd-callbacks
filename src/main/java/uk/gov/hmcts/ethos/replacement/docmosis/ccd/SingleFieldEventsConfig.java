...
public abstract class SingleFieldEventsConfig<T extends CaseData> implements CCDConfig<T, EtState, EtUserRole> {
    ...
    public void configure(ConfigBuilder<T, EtState, EtUserRole> configBuilder) {
        ...
        regionalCaseworkerEvent(configBuilder.event("addAmendClaimantRepresentative").forAllStates())
            ...
            .aboutToSubmitCallbackUrl("${ET_COS_URL}/addAmendClaimantRepresentative/aboutToSubmit")
            .submittedCallbackUrl("${ET_COS_URL}/addAmendClaimantRepresentative/amendClaimantRepSubmitted")
            .fields()
            .page("1")
            .field(CaseData::getClaimantRepresentedQuestion)
            .optional()
            .showSummary()
            .caseEventColumn(PAGE_COLUMN_NUMBER, 1)
            .done()
            .field(CaseData::getRepresentativeClaimantType)
            .showCondition("claimantRepresentedQuestion=\"Yes\"")
            .showSummary()
        ...
        claimantRespondToNotificationFields(
            configBuilder.event("claimantRespondToNotification")
                .forAllStates()
                ...
                .showSummary()
                .showCondition("caseType=\"dummy\"")
                .aboutToStartCallbackUrl("${ET_COS_URL}/claimantRespondNotification/aboutToStart")
                .aboutToSubmitCallbackUrl("${ET_COS_URL}/claimantRespondNotification/aboutToSubmit")
                .submittedCallbackUrl("${ET_COS_URL}/claimantRespondNotification/submitted")
        )
            .grant(Permission.CRU, EtUserRole.CLAIMANT_SOLICITOR)
            .grant(Permission.CRUD, EtUserRole.CASEWORKER_EMPLOYMENT_API);
    ...
    private Event.EventBuilder<T, EtUserRole, EtState> claimantRespondToNotificationFields(
        Event.EventBuilder<T, EtUserRole, EtState> event
    ) {
        return event.fields()
            .page("1")
            ...
            .mandatory()
            .showSummary()
            .caseEventColumn("CallBackURLMidEvent", "${ET_COS_URL}/claimantRespondNotification/midDetailsTable")
            ...
            .readOnly()
            .showCondition("claimantNotificationTableMarkdownLabel=\"dummy\"")
            .caseEventColumn("PageLabel", "View a judgment, order or notification")
            .caseEventColumn(PAGE_COLUMN_NUMBER, null)
            .done()
            .field(CaseData::getClaimantNotificationTableMarkdownLabel)
            .readOnly()
            .caseEventColumn(PAGE_COLUMN_NUMBER, null)
            .done()
            .field(CaseData::getClaimantNotificationResponseText)
            .optional()
            .showSummary()
            .caseEventColumn(PAGE_COLUMN_NUMBER, null)
            .done()
            .field(CaseData::getClaimantNotificationSupportingMaterial)
            .mandatory()
            .showSummary()
            .caseEventColumn(PAGE_COLUMN_NUMBER, null)
            .done()
            .field("claimantNotificationSupportingMaterialLabel")
            .readOnly()
            .showCondition("claimantNotificationSupportingMaterial=\"Yes\"")
            .caseEventColumn(PAGE_COLUMN_NUMBER, null)
            .done()
            .field(CaseData::getClaimantNotificationDocuments)
            .showCondition("claimantNotificationSupportingMaterial=\"Yes\"")
            .showSummary()
            .caseEventColumn("CallBackURLMidEvent", "${ET_COS_URL}/claimantRespondNotification/midValidateInput")
            .caseEventColumn(PAGE_COLUMN_NUMBER, null)
            .done()
            .page("3")
            ...
            .caseEventColumn(PAGE_COLUMN_NUMBER, null)
            .done()
            .field(CaseData::getIsRespondentSystemUser)
            .readOnly()
            .showCondition("claimantNotificationCopyToOtherParty=\"dummy\"")
            .caseEventColumn(PAGE_COLUMN_NUMBER, null)
            .done()
            .field("claimantRule92TextWhenRespOffline")
            .readOnly()
            .showCondition("isRespondentSystemUser=\"No\"")
            .caseEventColumn(PAGE_COLUMN_NUMBER, null)
            .done()
            .field(CaseData::getClaimantNotificationCopyToOtherParty)
            .mandatory()
            .showSummary()
            .caseEventColumn(PAGE_COLUMN_NUMBER, null)
            .done()
            .field(CaseData::getClaimantNotificationsCopyNoDetails)
            .mandatory()
            .showCondition("claimantNotificationCopyToOtherParty=\"No\"")
            .showSummary()
            .caseEventColumn(PAGE_COLUMN_NUMBER, null)
            .done()
            .done();
